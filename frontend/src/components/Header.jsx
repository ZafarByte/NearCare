  ...
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-[#0f172a] rounded-lg px-6 md:px-10'>
        ...
        <div className='md:w-1/2 flex flex-col items-start justify-center  gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            ...
            <a  href="" className='flex items-center gap-2 bg-[#0ea5e9] px-8 py-3 rounded-full text-[#f1f5f9] text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300 '>
