  ...
  return (
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      <div className="flex items-center gap-4">
        ...
        <div
          className={`${
            showMenu ? "fixed w-full min-h-screen bg-black/30 z-30 left-0 top-0" : "h-0 w-0"
          } md:hidden transition-all`}
        >
          <div
            className={`bg-white shadow-lg rounded-b-2xl w-full max-w-xs ml-auto min-h-screen transition-all duration-300 ${
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-6 border-b border-gray-100">
              ...
              <img
                ...
                className="h-7 w-7 cursor-pointer hover:scale-110 transition-transform duration-200"
              />
            </div>
            ...
            <div className="px-5 py-8 flex flex-col gap-8 h-full justify-between min-h-[60vh]">
              ...
              <ul className="flex flex-col gap-6">
                <NavLink
                  ...
                  to="/"
                  className="text-lg font-semibold text-gray-700 hover:text-[#0f172a] transition-colors duration-200"
                >
                  Home
                </NavLink>
                <NavLink
              ...
              {token ? (
                <div className="flex flex-col gap-2 mt-8">
                  ...
                  {showProfileDropdown && (
                    <div
                      className="min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4 mt-2 shadow"
